            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="index_ketoan.php" class="nav-item nav-link active">Trang Chủ</a>
                       <a href="#" class="nav-item nav-link">Nhân viên : <?php echo isset($_SESSION['TenDangNhap']) ? $_SESSION['TenDangNhap'] : ''; ?></a>
